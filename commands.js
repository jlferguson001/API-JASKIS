...
db.bounties.insertOne({ name:'Thanoceros', species: 'Rhinoceros', locations: 'Grasslands', wantedFor: 'Eating too much grass', client: 'Songbird', reward: 10000, captured: false})
...
{ _id: ObjectId("62a93fb7dbc83e4060b877e0"),
  name: 'Nebullama',
  species: 'Llama',
  location: 'Grasslands',
  wantedFor: 'Drinking all the water from the ocean',
  ...
  reward: 2500,
  captured: false }
{ _id: ObjectId("62a93fb7dbc83e4060b877e2"),
  name: 'Wrecking Crows',
  species: 'Crow',
  location: 'Grasslands',
  wantedFor: 'Cawing too loudly',
...
{ _id: ObjectId("62a93f3ddbc83e4060b877de"),
  name: 'Thanoceros',
  species: 'Rhinoceros',
...
{ _id: ObjectId("62a93fb7dbc83e4060b877e2"),
  ...
  reward: 40000,
  captured: false }
{ _id: ObjectId("62a93fb7dbc83e4060b877e3"),
  name: 'Grandhog',
  species: 'Groundhog',
  location: 'Woodlands',
  wantedFor: 'Not coming out of the hole on time and prolonging winter',
...
{ _id: ObjectId("62a93f3ddbc83e4060b877de"),
  ...
  reward: 10000,
  captured: false }
{ _id: ObjectId("62a93fb7dbc83e4060b877df"),
  name: 'Lokinkajou',
  species: 'Kinkajou',
  location: 'Tropical rainforest',
  wantedFor: 'Partying too late at night',
...
{ _id: ObjectId("62a93fb7dbc83e4060b877e0"),
  ...
  reward: 2500,
  captured: false }
{ _id: ObjectId("62a93fb7dbc83e4060b877e1"),
  name: 'Polarwind',
  species: 'Polar Bear',
  location: 'Arctic',
  wantedFor: 'Not hibernating',
...
{ _id: ObjectId("62a93fb7dbc83e4060b877e3"),
  ...
  reward: 50000,
  captured: false }
{ _id: ObjectId("62a93fb7dbc83e4060b877e4"),
  name: 'Grim Panda',
  species: 'Giant Panda',
  location: 'Temperate forest',
  wantedFor: 'Eating all the bamboo',
